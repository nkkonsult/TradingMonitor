...
%  - Volumétrie : 45 008 trades exploitables (dont oracle 6 798), 501 titres.
...
\]
où MSB (\emph{Mean Square Between}) est la variation \emph{entre} les
...
\emph{à l'intérieur} d'un titre, donc intra-grappe, c'est-à-dire la moyenne
