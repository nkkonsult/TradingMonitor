...
Sa mise en œuvre suppose  : que l'edge 
vérifie un critère de normalité […], et que les trades soient indépendants les uns des autres. La première sera assouplie par le TCL (ci-après) ; 
la seconde, plus délicate, sera examinée en section suivante.
...
largement suffisant pour appliquer le TCL.
